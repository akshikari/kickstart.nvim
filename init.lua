...
-- Automatically return to the last cursor position when reopening a file
...
-- Things I want to happen not from kickstart

-- Auto-import dependencies as I type and organize imports (when possible)
...
-- Set neovim Python version to whatever is the current system python version from pyenv
